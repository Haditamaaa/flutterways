...
class _weatherState extends State<weather> {
  ...
  weather_api() async {
    ...
    print(latitude);
    print(longitide);
    http.Response response = await http.get(Uri.parse('$weatherApiUrl?lat=$latitude&lon=$longitide&appid=$apiKey&units=metric'));
    print('$weatherApiUrl?lat= $latitude &lon=$longitide&appid=$apiKey&units=metric');
        ...
        children: [
          ...
          Positioned(
              child: SafeArea(
                child: Column(
                  children: [
                    Padding(padding: EdgeInsets.symmetric(horizontal: 18, vertical: 25),
                      child: Row(
                        children: [
